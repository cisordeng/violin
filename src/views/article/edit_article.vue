...
export default {
  ...
  methods: {
    async onClickPost() {
      ...
      if (this.isNew) {
        ArticleService.newArticle(this.article.title, this.article.content).then((data) => {
          this.$router.push({
            path: '/article',
            query: {
              id: data.id,
        ...
        ArticleService.updateArticle(this.article.id, this.article.title, this.article.content).then(() => {
          this.$router.push({
            path: '/article',
            query: {
              id: this.article.id,
