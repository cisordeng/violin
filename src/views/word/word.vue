      ...
      <div class="v-i-word">
        ...
        <div class="v-i-action">
          <div class="v-i-comment">
            ...
            <div class="v-i-count">{{word.comments && word.comments.length}}</div>
          </div>
        </div>
      </div>
      <comment :newComment="newComment" :comments="word.comments" class="v-i-comments"></comment>
    </div>
    <svg
      style="display: none;"
...
export default {
  ...
  async mounted() {
    ...
    this.newComment.resource = this.word;
